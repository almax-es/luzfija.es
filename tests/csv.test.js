...
describe('csvErrorCodeForTracking - códigos de error para analítica', () => {
  ...
  it('clasifica los mensajes conocidos del importador', () => {
    ...
    // periodo-duplicado (14/08/2026): los tres parsers (tabular, matriz, Datadis mensual)
    // comparten esta categoria; probado con acento (dia/mes) para confirmar que el matching
    // funciona pese a que firstLine ya paso por normalize('NFD') y estos fragmentos no.
