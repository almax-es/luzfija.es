...
// Cada caso crea un repo Git y lanza varios procesos. En la suite paralela de CI
// Windows puede superar el timeout genérico de 5 s aunque aislado termine bien.
describe('pre-commit-sync integration (isolated temp repo)', { timeout: 15_000 }, () => {
  let tmpDir;
