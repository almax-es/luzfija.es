...
describe('Sistema de Tarifas (sin caché)', () => {
  ...
  // de la sesión. La validación es de ESTRUCTURA, no de reglas comerciales: exige nombre,
  // tipo 1P/3P y los cinco precios finitos, que es lo que el comparador necesita para
  // calcular una fila. Un 0 es un precio válido (p2 puede valer 0 por contrato).
