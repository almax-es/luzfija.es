...
describe('Productos monetarios decimales exactos', () => {
  ...
  // 0,095 x 85 = 8,075 exacto, pero en coma flotante sale 8,07499... y un
  // redondeo ingenuo da 8,07. Precios tomados de Spock 24 Horas (caso real que
  // destapo el bug), fijados aqui para no depender de tarifas.json.
  it('redondea 0,095 x 85 kWh a 8,08 € en home, desglose y simulador mensual', async () => {
    const tarifa = {
      nombre: 'Frontera 8,075 €',
      cPunta: 0.095, cLlano: 0.095, cValle: 0.095,
      p1: 0.09863, p2: 0.09863,
      tipo: '1P',
      incluyeServiciosAjuste: true,
      fv: { exc: 0, tipo: 'NO COMPENSA', tope: '—', bv: false, reglaBV: 'NO APLICA', precioBV: 0 },
      requiereFV: false
    };
