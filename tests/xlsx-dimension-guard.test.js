...
describe('assertXlsxSheetWithinLimits', () => {
  ...
  it('con sheets:0 la segunda hoja patologica no llega a materializarse', () => {
    ...
    // Plazo propio: escribir 300.000 celdas tarda 1-1,6 s aislado, pero con la suite completa en
    // paralelo supero los 5 s por defecto y paro el .bat de despliegue (16/09/2026). El test mide
    // que la segunda hoja no se materializa, no la velocidad.
  }, 30000);
