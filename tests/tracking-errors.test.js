...
describe('Build de la pagina', () => {
  it('toma el build de la pagina de la URL con la que su HTML pidio tracking.js (ronda 42)', () => {
    // Va al final del fichero: el primer bootstrap de tracking.js fija su origen para todo el
    // fichero, y un currentScript simulado en el primero rompe la atribucion de los demas tests.
    // Un HTML antiguo pide tracking.js?v=<antiguo>; aunque la red entregue el fichero del build
    // nuevo, el build de la pagina tiene que seguir siendo el antiguo para que lf-sw-update.js
    // detecte la mezcla frente a GET_VERSION.
    Object.defineProperty(document, 'currentScript', {
      configurable: true,
      get: () => ({ src: 'https://luzfija.es/js/tracking.js?v=20260917-100436' })
    });
    try {
      bootstrapTracking();
      expect(window.__LF_BUILD_ID).toBe('20260917-100436');
    } finally {
