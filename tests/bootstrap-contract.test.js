...
const DEFERRED_USE_DEPENDENCIES = {
  ...
  [SOLAR]: [
    ...
    // window.LF.csvUtils.validatePvpcDayCoverage/formatYmdInTimeZone: validador de dia
    // civil compartido (bloqueante 2, 12/08/2026) para el mismo contrato que home y
    // Observatorio.
    ['js/lf-csv-utils.js', 'js/lf-surplus-prices.js', 'uso perezoso'],
  ...
  [STATS]: [
    ...
    ['js/lf-config.js', 'js/lf-surplus-prices.js', 'uso perezoso'],
    ['js/lf-csv-utils.js', 'js/pvpc-stats-csv.js', 'uso perezoso'],
    // Mismo validador compartido de dia civil, ahora tambien consumido por el motor de
    // anios del Observatorio y por excedentes (bloqueante 2, 12/08/2026).
    ['js/lf-csv-utils.js', 'js/pvpc-stats-engine.js', 'uso perezoso'],
    ['js/lf-csv-utils.js', 'js/lf-surplus-prices.js', 'uso perezoso']
  ]
};
