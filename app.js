      ...
      requestAnimationFrame(() => {
        ...
        s.forEach((r, idx) => {
          ...
          tr.innerHTML =
            ...
            `<td class="total-cell"><strong class="total-price js-total-amount"${isBV ? ` data-pagas="${escapeHtml(bvPagasFmt)}" data-ranking="${escapeHtml(bvRankingFmt)}"` : ""}>${escapeHtml(r.total)}</strong></td>`+
