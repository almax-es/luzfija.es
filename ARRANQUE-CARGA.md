...
solicitudes funcionales cerradas `{ app, dependency, build }` en
...
y SW se presenta como pestaña obsoleta. El puente funciona aunque `tracking.js`
sea precisamente uno de los scripts que no llego a cargar.
...
| `factura-parsers.js` | `factura.js` no continua, deja aviso accionable, emite `init-incompleto/home/factura-parsers` y el coordinador de SW ofrece recarga tras comprobar si la pestaña esta obsoleta |
