...
| GoatCounter | snapshot upstream del 03/08/2026 + 2 parches locales | Repositorio upstream `arp242/goatcounter`; `count.js` no tiene paquete/versión npm propia | ✅ no se localizó un advisory publicado específico para el script vendorizado en la revisión fechada |
