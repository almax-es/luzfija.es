...
- 33.515 lineas JS aproximadas.
- 123 tarifas en `tarifas.json`.
- Suite de tests Vitest con 128 archivos y 2052 casos.
...
columnas, formato R2, volumen, codigos centinela (`R2-999` cierra la tabla, asi que un listado cortado por el final no pasa) y metadatos; una fila con datos y sin codigo R2 aborta en vez de perderse, y los tests del censo se ejecutan
