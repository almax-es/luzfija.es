...
- 25.395 lineas JS aproximadas.
- 120 tarifas en `tarifas.json`.
- Suite de tests Vitest con 85 archivos y 1036 casos.
...
- revisar cambios fiscales electricos: a 01/08/2026 el IPC de electricidad de junio no activa la reduccion de agosto y el comparador sigue en IVA 21% e IEE 5,11269632%; el IPC definitivo de julio decide si el RDL 18/2026 reduce ambos impuestos durante septiembre,
