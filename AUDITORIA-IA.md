...
| Oraculo independiente del camino horario | Auditada 23/09/2026 (ronda 46) en caja negra: 52 escenarios sinteticos y 8 curvas reales en las tres zonas. P1/P2/P3 (incluida la punta de Ceuta/Melilla y los cambios de hora), PVPC horario en sus tres modos y excedentes indexados cuadran. **1 bug CORREGIDO**: en Canarias los excedentes indexados se valoraban con el precio de la hora anterior (-7,7% en una curva real) porque `data/surplus/8742` iba en reloj de Madrid; el dato se guarda ahora en hora canaria | [Oraculo Independiente Del Camino Horario (Ronda 46)](AUDITORIA-REGISTRO.md#oraculo-independiente-camino-horario-ronda-46-23-09-2026) |
