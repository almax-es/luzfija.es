...
- Las validaciones E2E del 22/07/2026 generaron trafico sintetico en ambas familias. Ventanas CONFIRMADAS contra el export de `2026-07-22T12:57:08Z`: `09:00Z` (build `20260722-091724`) y `11:00Z` (build `20260722-103502`). El cubo `12:00Z` tiene 73 hits de trafico normal y cero eventos de error, pese a que la auditoria final se anuncio en esa hora: revisalo en el siguiente export por si fue retardo de agregacion. Moraleja practica: verifica en que cubos horarios aparecen ambas familias y ajusta la exclusion a lo que diga el dato; no heredes una ventana declarada ni des por contaminado todo el build.
