...
| Escaneo WCAG automatico (ronda 53) | Auditado 24/09/2026: axe-core en Chrome real, 33 paginas x 2 anchos x 2 temas (132 escaneos). Cero fallos de contraste, nombres, formularios o ARIA. 5 reglas corregidas hasta cero violaciones (zona tactil del pie solar, orden de encabezados, esquina de tabla vacia, `nav` sin nombre, cabecera fuera de landmark). La mascara de fechas SEO ignora ahora cambios solo de accesibilidad. No equivale a prueba con lector de pantalla real | [Escaneo WCAG Automatico Con axe-core (Ronda 53)](AUDITORIA-REGISTRO.md#escaneo-wcag-axe-ronda-53-24-09-2026) |
...
| Minimo del IEE con energia compensada (ronda 50) | DECIDIDO 23/09/2026: se mantiene el minimo sobre todos los kWh de red. El modelo 560 (Orden HAC/1433/2024) confirma que la energia exenta del 94.9 no lleva minimo, pero ninguna norma, consulta DGT ni modelo oficial fija como convertir la compensacion economica en kWh exentos. Un cambio con credito / precio del excedente se revirtio el mismo dia por medir el lado equivocado. Impacto maximo 0,001 EUR por kWh compensado, siempre al alza. Solo se reabre con esa regla y fuente primaria | [Minimo Del IEE: Cambio Revertido (Ronda 50)](AUDITORIA-REGISTRO.md#minimo-iee-compensacion-revertido-ronda-50-23-09-2026) |
| Pagina 404 y URLs antiguas (ronda 52) | Auditada 24/09/2026, primera vez. 404 real en cualquier profundidad, variantes de URL y alias correctos. CORREGIDO que los enlaces rotos no fueran medibles: `js/not-found.js` envia `pagina-404/<pagina existente mas parecida>` (nunca la ruta tecleada) y sugiere esa pagina en pantalla | [Pagina 404 Y URLs Antiguas (Ronda 52)](AUDITORIA-REGISTRO.md#pagina-404-y-urls-antiguas-ronda-52-24-09-2026) |
| Vigencia normativa a 24/09/2026 (ronda 54) | Revision externa + BOE. Fiscalidad de octubre sin cambios (el RDL 18/2026 solo cubre agosto y septiembre): IVA 21 % e IEE 5,11269632 %. Valores fiscales y regulatorios relevantes de `lf-config.js` confirmados. Unico cambio: Auto+ Linea 2 (BOE 24/09/2026), anadida como actualizacion fechada sin mover el sello de la guia. No fue lectura literal de las 25 guias | [Vigencia Normativa A 24/09/2026 (Ronda 54)](AUDITORIA-REGISTRO.md#vigencia-normativa-ronda-54-24-09-2026) |
| Ciclo de vida del navegador (ronda 55) | Auditado 25/09/2026, primera vez: bfcache, dos pestanas, reanudacion tras suspension y session restore. Sin cambios: PVPC tras cruzar medianoche (periodo visible, un dia de ~30) y escrituras concurrentes de dos pestanas quedan como decisiones BAJA | [Ciclo De Vida Del Navegador (Ronda 55)](AUDITORIA-REGISTRO.md#ciclo-de-vida-del-navegador-ronda-55-25-09-2026) |
| Buscador de guias (`js/guides-search.js`) | **Hueco deliberado, no auditado como area** (05/09/2026). Cubiertos por tests dedicados el indice y la resiliencia de red; sin auditar el comportamiento de la UI (orden de resultados, teclado, estados vacios). Techo de impacto cosmetico y sin superficie XSS (todo `textContent`). 23/09/2026: CORREGIDO que cada prefijo tecleado mandase su propio evento `guias-busqueda` (11 por busqueda); ahora uno por busqueda asentada. CORREGIDA tambien la relevancia: el prefijo inverso aceptaba tokens de 1-2 letras y "aerotermia", "alquiler" o "estafa" devolvian las 25 guias; y el fragmento de "Coincide en contenido" (219 de 240 tarjetas sin la palabra) muestra ahora la zona donde aparece. 24/09/2026, tras tres revisiones externas: sinonimos de consulta (nocturno -> noche, denunciar -> reclamar) porque el Y logico dejaba en 1 resultado "horario nocturno" o "denunciar comercializadora", y hasta 5 "relacionados" acotados (palabra distintiva en campo fuerte, fuera del contador y de la analitica) cuando una consulta de varias palabras tiene menos de 3 completos. NO relajes el prefijo inverso para recuperar consultas: esa fue la causa del ruido. No lo reportes como zona huerfana sin leer la entrada | [Buscador De Guias: Hueco De Auditoria Deliberado](AUDITORIA-REGISTRO.md#buscador-de-guias-hueco-deliberado-05-09-2026) |
