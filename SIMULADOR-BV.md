...
|---|---|---|
| **Península/Baleares** | IVA vigente (21% en agosto de 2026; septiembre depende de la condicion de IPC del RDL 18/2026) | mismo tipo IVA vigente |
...
1. Editar `tarifas.json` (en la práctica: la Excel privada + generador; ver `JSON-SCHEMA.md`)
...
4. Añadir casos de frontera en `tests/fiscal.test.js`,
   `tests/bv-fiscal-align.test.js` y tests de desglose. No dupliques porcentajes
   dentro de `bv-sim-monthly.js`: el simulador consume `LF_CONFIG`.
