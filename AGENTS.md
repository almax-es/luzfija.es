...
- "El minimo del IEE (1 EUR/MWh) deberia excluir la energia compensada (art. 94.9)." Evaluado y mantenido el 23/09/2026: el modelo 560 confirma que la energia exenta no lleva minimo, pero ninguna fuente fija como convertir la compensacion economica en kWh exentos, y un intento se revirtio el mismo dia. Solo se reabre con esa regla y fuente primaria. Ver `CALC-FAQS.md` y la ronda 50 de `AUDITORIA-REGISTRO.md`.
- "El tope por kW (`maxConsumoAnualPorKw`) deberia calcularse con P1, con la mayor o con la suma de potencias." No es un bug: se usa la MENOR de P1 y P2 por decision del 24/09/2026 (la comercializadora no aclara cual usa y avisar de menos es el error caro). Ver `AUDITORIA-REGISTRO.md`.
