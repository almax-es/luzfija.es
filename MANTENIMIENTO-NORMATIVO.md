...
| Servicios de ajuste | Precio medio mensual SSAA para tarifas que no los incluyen en el precio publicado | Diario por automatizacion; usar ultimo mes completo disponible | REE/ESIOS indicador 10328 | `/data/ssaa/`, Excel privada, calculo y ranking de home y simulador solar |
...
- Agosto de 2026, al publicarse el IPC definitivo de julio: comprobar de inmediato la subclase 04.5.10 Electricidad. Si supera en mas de un 15% julio de 2025, el RDL 18/2026 activa durante septiembre IVA 10% para los suministros previstos en su articulo 11 e IEE 0,5% con los minimos de su articulo 13. Si no lo supera, se mantienen los tipos generales. Esta comprobacion afecta a `LF_CONFIG`, tests y copy fiscal antes del 01/09/2026.
...
- `10 kW` no siempre significa lo mismo: PVPC tiene elegibilidad `<= 10 kW`; la rebaja temporal de IVA electrico de 2026 se desactivo desde el 01/06/2026, pero el RDL 18/2026 puede reactivarla en septiembre si se cumple su condicion de IPC de julio; otras reglas pueden usar limites distintos.
