...
| Factura PDF/QR CNMC y censo R2 | Formato de URL QR, campos, codigos de contrato/factura, cambios en modelos y altas/cambios de comercializadoras | Censo mensual automatizado en modo espejo (03/09/2026): se replica lo que sirva la CNMC —altas, bajas, renombrados, contactos y metadatos— sin revision previa. Lo unico que detiene la publicacion es un fallo propio: el parser aborta si cambia el formato de la tabla y los tests del censo corren siempre antes del commit. La clasificacion de `scripts/classify-cnmc-commercializers-update.mjs` sigue existiendo, pero solo describe el cambio en el resumen del run y en el mensaje de commit. Regenerar aparte antes de publicar cambios del extractor y cuando fallen facturas reales | Resolucion CNMC publicada en BOE, censo publico CNMC y facturas reales anonimizadas | `js/factura-parsers.js`, `js/factura.js`, `data/cnmc-commercializers.json`, `scripts/sync-cnmc-commercializers.mjs`, `scripts/classify-cnmc-commercializers-update.mjs`, `.github/workflows/cnmc-commercializers.yml`, tests de factura y censo |
...
- 25/09/2026: revision normativa externa de guias y `lf-config.js` contrastada con el BOE consolidado: bono social 42,5%/57,5% (RDL 7/2026 art. 1.1) y 10 dias habiles (RD 897/2017 art. 8.2), nulidad por llamadas no solicitadas (Ley 10/2025, DF 3a, art. 62.1 TRLGDCU), rango 400 (Resolucion BOE-A-2026-8409, 6 meses), IGIC (art. 52.r al 0%, art. 54 al 3%, 7% general) e IPSI (art. 18 solo fija la horquilla 0,5-10%; 1% y 4% salen de las ordenanzas). Sin errores de valor; solo se corrigieron las referencias de `lf-config.js` y el sello de la guia del bono social.
- 24/09/2026: el RDL 18/2026 (BOE-A-2026-14112) solo regula agosto (art. 12, IPC de junio) y septiembre (arts. 11 y 13, IPC de julio). No contiene mecanismo para octubre ni se ha localizado norma posterior que lo prorrogue (comprobado en el texto del BOE y confirmado por la revision externa del mismo dia): desde el 01/10/2026 siguen IVA 21% e IEE 5,11269632% en Peninsula/Baleares. Si se publicase una prorroga, revisar de que IPC depende cada mes.
...
- 24/09/2026: publicada la convocatoria 2026 de la **Linea 2** de Auto+ (extracto BOE-B-2026-30841, BDNS 931088): empresas y autonomos, excluidos los concesionarios o puntos de venta con epigrafe IAE 615.1 o 654.1; 50 millones (42 M EUR para empresas privadas y 8 M EUR para profesionales autonomos); solicitudes del 01/10/2026 a las 10:00 al 31/12/2026 a las 14:00. Anadida como actualizacion fechada en la guia de coche electrico, sin mover el sello "revisada a 14/09/2026" del resto del bloque. La guia de punto de recarga no cambia: habla del cargador domestico, no de la compra de vehiculos. El RD fija la vigencia del programa hasta el 31/12/2030, pero NO obliga a convocar cada anio: segun el articulo 5.2, cada convocatoria se aprueba por orden ministerial y solo puede incluir una de las dos lineas. No dar por hecha una convocatoria anual.
