...
| Factura PDF/QR CNMC y censo R2 | Formato de URL QR, campos, codigos de contrato/factura, cambios en modelos y altas/cambios de comercializadoras | Trimestral y cuando fallen facturas reales; regenerar el censo antes de publicar cambios del extractor y revisar `_meta.count/sourceRows/duplicateCodes/invalidWebsiteCodes` | Resolucion CNMC publicada en BOE, censo publico CNMC y facturas reales anonimizadas | `js/factura-parsers.js`, `js/factura.js`, `data/cnmc-commercializers.json`, `scripts/sync-cnmc-commercializers.mjs`, tests de factura y guias |
