...
(function(global) {
  ...
  const LF_CONFIG = {
    ...
    // ═══════════════════════════════════════════════════════════════════
    // PEAJES + CARGOS DE POTENCIA PVPC — Tarifa 2.0TD (€/kW·día)
    // El termino de potencia del PVPC es FPU = FPUP (peaje) + FPUC (cargo) +
    // margen de comercializacion (RD 216/2014 art. 8.1, tras su modificacion
    // por RD 148/2021). Los valores de aqui ya suman peaje + cargo (no son
    // peaje puro): peaje P1 23,324952 + cargo P1 4,379461 = 27,704413 €/kW·año.
    // Las constantes diarias usadas por el motor se mantienen sin cambios.
    // Peaje: Resolución CNMC 18/12/2025 (BOE-A-2025-26348).
    // Cargo: Orden TED/1524/2025 (BOE-A-2025-26705).
    // Vigentes desde 1 de enero de 2026
    // ═══════════════════════════════════════════════════════════════════
    peajesPotenciaPVPC: {
      p1:     0.075901, // €/kW·día peaje + cargo de potencia P1 (punta)
      p2:     0.001987, // €/kW·día peaje + cargo de potencia P2 (valle)
