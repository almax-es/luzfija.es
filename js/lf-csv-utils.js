...
(function() {
  ...
  function csvErrorCodeForTracking(message) {
    ...
    const rules = [
      ...
      ['rango-fechas',         ['abarca', 'meses distintos', 'recorte a 12 meses', 'datos muy fragmentados']],
  ...
  function parseEnergyTableRows(rows, options = {}) {
    ...
    const unmappedSolarFound = detectUnmappedSolarColumns(headersNorm, mapping, dataRows, { parseNumber });
  ...
  // de octubre, cuando a las 03:00 se vuelve a las 02:00 y el dia tiene 25 horas.
