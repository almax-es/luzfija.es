...
(function() {
  ...
  Object.assign(Desglose, {
    calcularDesglose(datos) {
      ...
      const pot = roundMoneyProducts([[potenciaP1, dias, precioP1], [potenciaP2, dias, precioP2]]);
      const consBase = roundMoneyProducts([[consumoPunta, precioPunta], [consumoLlano, precioLlano], [consumoValle, precioValle]]);
      ...
      if (solarOn && excedentes > 0 && precioCompensacion > 0 && tipoCompensacion !== 'NO COMPENSA') {
        ...
        const creditoPotencial = roundMoneyProducts([[exKwh, precioCompensacion]]);
