...
(function() {
  ...
  function validateInputs() {
    ...
    if (!p1Raw) {
      ...
      markInvalid(el.inputs.p1);
    } else if (p1Num > (window.LF_CONFIG?.POTENCIA_MAX_KW || 20)) {
      message = `La potencia P1 debe ser ≤ ${window.LF_CONFIG?.POTENCIA_MAX_KW || 20} kW.`;
      markInvalid(el.inputs.p1);
    }
    ...
    if (!message && !p2Raw) {
      ...
      markInvalid(el.inputs.p2);
    } else if (!message && p2Num > (window.LF_CONFIG?.POTENCIA_MAX_KW || 20)) {
      message = `La potencia P2 debe ser ≤ ${window.LF_CONFIG?.POTENCIA_MAX_KW || 20} kW.`;
      markInvalid(el.inputs.p2);
    }
