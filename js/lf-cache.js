...
(function() {
  ...
  // Validacion minima compartida con el simulador solar (ver js/lf-utils.js:esTarifaUtilizable)
  // para que ambos consumidores de tarifas.json apliquen el mismo criterio "todo o nada".
    ...
    tarifasFetchPromise = (async () => {
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt += 1) {
        ...
        try {
          ...
          // ranking incompleto sin que el usuario pueda saberlo.
          if (!tarifas || tarifas.length === 0 || !tarifas.every(esTarifaUtilizable)) {
