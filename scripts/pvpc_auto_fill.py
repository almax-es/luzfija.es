#!/usr/bin/env python3
"""
PVPC dataset builder - correction-window version

Si ejecutas sin --from/--to, re-descarga una ventana móvil de seis meses completos
y hasta mañana para incorporar rectificaciones recientes. La comprobación de frescura
del workflow detecta huecos de cualquier antigüedad; para reparar uno anterior a esa
ventana hay que lanzar un backfill manual con --from.
