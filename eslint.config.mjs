// Configuracion ESLint (flat config): solo deteccion de bugs, sin reglas de estilo.
// Alcance: js/ (codigo de produccion).
// Todas las reglas activas estan en nivel `error`; no hay avisos pendientes ni
// reglas aparcadas. Las excepciones deliberadas (catch sin variable, params con
// prefijo _) se declaran en las opciones de cada regla, mas abajo.
