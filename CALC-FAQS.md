...
**Normativa**:
- Península: IVA estándar (Ley 37/1992). La rebaja temporal se desactivo el 01/06/2026. El IPC anual de electricidad de junio fue 6,0%, no supero el umbral de mas del 15% del RDL 18/2026 y no activa la reduccion de agosto. Septiembre depende del IPC definitivo de julio: si supera ese umbral, los suministros contemplados por el articulo 11 tributaran al 10% y el IEE bajara al 0,5% con minimo legal durante ese mes.
...
if (tipoImpuesto === 'IGIC') {
  ...
  // IVA (Península)
  iva = base × tipoIvaVigente; // 21% a 01/08/2026
}
```
